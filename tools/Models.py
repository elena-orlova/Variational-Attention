...
class EncoderBase(nn.Module):
    ...
    and required by :obj:`tools.Models.NMTModel`.
...
class MeanEncoder(EncoderBase):
    ...
    Args:
       ...
       embeddings (:obj:`tools.modules.Embeddings`): embedding module to use
    """
...
class RNNDecoderBase(nn.Module):
    ...
    Args:
       ...
       num_layers (int) : number of stacked layers
       hidden_size (int) : hidden size of each layer
       attn_type (str) : see :obj:`tools.modules.GlobalAttention`
       coverage_attn (str): see :obj:`tools.modules.GlobalAttention`
       context_gate (str): see :obj:`tools.modules.ContextGate`
    ...
    def __init__(self, rnn_type, bidirectional_encoder, num_layers,
        ...
        if context_gate is not None:
            self.context_gate = tools.modules.context_gate_factory(
        ...
        self.attn = tools.modules.GlobalAttention(
            src_dim = memory_size,
            tgt_dim = hidden_size,
            attn_dim = attn_size,
        ...
        if copy_attn and not reuse_copy_attn:
            self.copy_attn = tools.modules.GlobalAttention(
...
class InputFeedRNNDecoder(RNNDecoderBase):
    ...
    def _build_rnn(self, rnn_type, input_size,
        ...
        if rnn_type == "LSTM":
            stacked_cell = tools.modules.StackedLSTM
        else:
            stacked_cell = tools.modules.StackedGRU
...
class NMTModel(nn.Module):
    ...
    def forward(self, src, tgt, lengths, dec_state=None):
        ...
        Returns:
            (:obj:`FloatTensor`, `dict`, :obj:`tools.Models.DecoderState`):
