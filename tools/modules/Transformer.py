...
import tools
from tools.Models import EncoderBase
from tools.Models import DecoderState
...
class PositionwiseFeedForward(nn.Module):
    ...
    def __init__(self, size, hidden_size, dropout=0.1):
        ...
        self.layer_norm = tools.modules.LayerNorm(size)
...
class TransformerEncoderLayer(nn.Module):
    ...
    def __init__(self, size, dropout,
        ...
        self.self_attn = tools.modules.MultiHeadedAttention(
...
class TransformerEncoder(EncoderBase):
    ...
    Args:
       ...
       embeddings (:obj:`tools.modules.Embeddings`):
    ...
    def __init__(self, num_layers, hidden_size,
        ...
        self.layer_norm = tools.modules.LayerNorm(hidden_size)
...
class TransformerDecoderLayer(nn.Module):
    ...
    def __init__(self, size, dropout,
        ...
        self.self_attn = tools.modules.MultiHeadedAttention(
                head_count, size, dropout=dropout)
        self.context_attn = tools.modules.MultiHeadedAttention(
                head_count, size, dropout=dropout)
        self.feed_forward = PositionwiseFeedForward(size,
                                                    hidden_size,
                                                    dropout)
        self.layer_norm_1 = tools.modules.LayerNorm(size)
        self.layer_norm_2 = tools.modules.LayerNorm(size)
