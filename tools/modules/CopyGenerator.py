...
class CopyGeneratorLossCompute(tools.Loss.LossComputeBase):
    """
    ...
    def _compute_loss(self, batch, output, target, copy_attn, align):
        ...
        scores_data = tools.io.TextDataset.collapse_copy_scores(
        ...
        if self.normalize_by_length:
            ...
            pad_ix = batch.dataset.fields['tgt'].vocab.stoi[tools.io.PAD_WORD]
