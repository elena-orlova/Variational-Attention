...
import tools
from tools.Utils import aeq, sequence_mask, Params, DistInfo
from tools.Models import MeanEncoder, RNNEncoder, InputFeedRNNDecoder, NMTModel, RNNDecoderState
...
class ViRNNDecoder(InputFeedRNNDecoder):
    def __init__(self, *args, **kwargs):
        ...
        self.attn = tools.modules.VariationalAttention(
